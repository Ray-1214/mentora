...
| 訓練營 | 高雄 7/24 ・ 台中 7/27 ・ 台北 7/29(網路直播 + 全程錄影) |
...
| 7/27 | 訓練營(台中場)— 對齊官方文件撰寫方式 |
| 7/28–8/3 | 依訓練營調整格式;內容灌入官方 .docx;demo 影片腳本 + 錄製 |
...
- 訓練營(台中場 7/27)出席 vs 繳交請假單?格式以訓練營教材為準,故影響文件排程。
